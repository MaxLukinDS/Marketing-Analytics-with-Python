...
'''Здась испоьлзуется online_retail'''
...
frequent_itemsets = apriori(onehot, min_support = 0.005, max_len = 3, use_colnames = True)
...
frequent_itemsets_1 = apriori(onehot, min_support = 0.003, max_len = 3, use_colnames = True)
# Compute frequent itemsets using a support of 0.001 and length of 3
frequent_itemsets_2 = apriori(onehot, min_support = 0.001, max_len = 3, use_colnames = True)
...
rules_1 = association_rules(frequent_itemsets_1, metric = "support", min_threshold = 0.0015)
# Compute all association rules for frequent_itemsets_2
rules_2 = association_rules(frequent_itemsets_2, metric = "support", min_threshold = 0.0015)
...
# Recover association rules using a minimum support threshold of 0.001
